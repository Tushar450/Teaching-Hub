  ...
  <body>
    <div class="container w-50 m-auto">
        ...
        <form action="action.php" method="POST" autocomplete="off">
            ...
            <!-- <div class="school my-4">
              <label for="school">School: </label>
              <input type="text" name="school" id="school" class="form-control" required>
            </div>
            <div class="standard my-4">
              <label for="standard">standard: </label>
              <input type="number" name="standard" id="standard" class="form-control" required>
            </div> -->
            ...
            <div class="pincode my-4">
              <label for="pincode">Pincode: </label>
              <input type="text" name="pincode" id="pincode" class="form-control" required>
            </div>
            <div class="qualification my-4">
